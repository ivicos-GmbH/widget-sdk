...
export class WidgetSDK {
    constructor() {
        ...
        this.openUrlResolvers = new Map();
        this.displayModeListeners = new Set();
    ...
    supportsDisplayModes() {
        var _a, _b, _c;
        return ((_c = (_b = (_a = this.context) === null || _a === void 0 ? void 0 : _a.displayModes) === null || _b === void 0 ? void 0 : _b.length) !== null && _c !== void 0 ? _c : 0) > 1;
    }
    getDisplayMode() {
